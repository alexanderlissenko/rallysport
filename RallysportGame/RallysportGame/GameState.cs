...
namespace RallysportGame
{
    ...
    public class GameState : IState
    {
        ...
        public override void Render(GameWindow gameWindow)
        {
            ...
            Vector3 camera_position =playerCar.getCarPos()+ behindcar;//sphericalToCartesian(camera_theta, camera_phi, camera_r, playerCar.getCarPos());
        ...
        public override void Update(GameWindow gameWindow) 
        {
            ...
            if (networkhandler.getStatus())
            {
                if (testtimer == 180)
                {
                    networkhandler.sendData(playerCar.getCarPos(),playerCar.getCarAngle());
                    testtimer = 0;
                }
                testtimer++;
